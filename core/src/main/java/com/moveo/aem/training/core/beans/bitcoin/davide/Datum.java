...
public class Datum{
    ...
    public List<TimeSery> getTimeSeries() { 
		 return this.timeSeries; } 
    public void setTimeSeries(List<TimeSery> timeSeries) { 
		 this.timeSeries = timeSeries; } 
    List<TimeSery> timeSeries;
    @JsonProperty("social_dominance_calc_24h_previous") 
    public int getSocial_dominance_calc_24h_previous() { 
		 return this.social_dominance_calc_24h_previous; } 
    public void setSocial_dominance_calc_24h_previous(int social_dominance_calc_24h_previous) { 
		 this.social_dominance_calc_24h_previous = social_dominance_calc_24h_previous; } 
    int social_dominance_calc_24h_previous;
    @JsonProperty("social_contributors_calc_24h_previous") 
    public int getSocial_contributors_calc_24h_previous() { 
		 return this.social_contributors_calc_24h_previous; } 
    public void setSocial_contributors_calc_24h_previous(int social_contributors_calc_24h_previous) { 
		 this.social_contributors_calc_24h_previous = social_contributors_calc_24h_previous; } 
    int social_contributors_calc_24h_previous;
    @JsonProperty("url_shares_calc_24h_previous") 
    public int getUrl_shares_calc_24h_previous() { 
		 return this.url_shares_calc_24h_previous; } 
    public void setUrl_shares_calc_24h_previous(int url_shares_calc_24h_previous) { 
		 this.url_shares_calc_24h_previous = url_shares_calc_24h_previous; } 
    int url_shares_calc_24h_previous;
    @JsonProperty("tweet_spam_calc_24h_previous") 
    public int getTweet_spam_calc_24h_previous() { 
		 return this.tweet_spam_calc_24h_previous; } 
    public void setTweet_spam_calc_24h_previous(int tweet_spam_calc_24h_previous) { 
		 this.tweet_spam_calc_24h_previous = tweet_spam_calc_24h_previous; } 
    int tweet_spam_calc_24h_previous;
    @JsonProperty("news_calc_24h_previous") 
    public int getNews_calc_24h_previous() { 
		 return this.news_calc_24h_previous; } 
    public void setNews_calc_24h_previous(int news_calc_24h_previous) { 
		 this.news_calc_24h_previous = news_calc_24h_previous; } 
    int news_calc_24h_previous;
    @JsonProperty("average_sentiment_calc_24h_previous") 
    public double getAverage_sentiment_calc_24h_previous() { 
		 return this.average_sentiment_calc_24h_previous; } 
    public void setAverage_sentiment_calc_24h_previous(double average_sentiment_calc_24h_previous) { 
		 this.average_sentiment_calc_24h_previous = average_sentiment_calc_24h_previous; } 
    double average_sentiment_calc_24h_previous;
    @JsonProperty("social_score_calc_24h_previous") 
    public int getSocial_score_calc_24h_previous() { 
		 return this.social_score_calc_24h_previous; } 
    public void setSocial_score_calc_24h_previous(int social_score_calc_24h_previous) { 
		 this.social_score_calc_24h_previous = social_score_calc_24h_previous; } 
    int social_score_calc_24h_previous;
    @JsonProperty("social_volume_calc_24h_previous") 
    public int getSocial_volume_calc_24h_previous() { 
		 return this.social_volume_calc_24h_previous; } 
    public void setSocial_volume_calc_24h_previous(int social_volume_calc_24h_previous) { 
		 this.social_volume_calc_24h_previous = social_volume_calc_24h_previous; } 
    int social_volume_calc_24h_previous;
    @JsonProperty("alt_rank_30d_calc_24h_previous") 
    public int getAlt_rank_30d_calc_24h_previous() { 
		 return this.alt_rank_30d_calc_24h_previous; } 
    public void setAlt_rank_30d_calc_24h_previous(int alt_rank_30d_calc_24h_previous) { 
		 this.alt_rank_30d_calc_24h_previous = alt_rank_30d_calc_24h_previous; } 
    int alt_rank_30d_calc_24h_previous;
    @JsonProperty("alt_rank_calc_24h_previous") 
    public int getAlt_rank_calc_24h_previous() { 
		 return this.alt_rank_calc_24h_previous; } 
    public void setAlt_rank_calc_24h_previous(int alt_rank_calc_24h_previous) { 
		 this.alt_rank_calc_24h_previous = alt_rank_calc_24h_previous; } 
    int alt_rank_calc_24h_previous;
